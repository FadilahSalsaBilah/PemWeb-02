...
<form method="POST" action="../../procces/produk/proses_produk.php">
  ...
  <div class="form-group row">
    <label for="harga_beli" class="col-4 col-form-label">Tipe Motor</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="harga_beli" name="tipe_motor_id" 
        value="<?=$row['tipe_motor_id']?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="stok" name="harga" value="<?=$row['harga']?>"
        type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">Merk</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="min_stok" name="merk_id" 
        value="<?=$row['merk_id']?>"
        type="text" class="form-control">
      </div>
    </div>
  ...
  <div class="form-group row">
    <label for="jenis" class="col-4 col-form-label">Tipe Motor</label> 
    <div class="col-8">
        <?php 
