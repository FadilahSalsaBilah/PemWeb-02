...
?>
      ...
      <a class="btn btn-success" href="../../pelanggan/form_pelanggan.php" role="button">Create Pelanggan</a>
...
<a class="btn btn-primary" href="../../pelanggan/pelanggan/delete_pelanggan.php?iddel=<?=$row['id']?>"
